...
const ARBsvg = (props:React.SVGProps<SVGSVGElement>) => {
    return (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 width="470.287px" height="514.251px" viewBox="0 0 470.287 514.251" enableBackground="new 0 0 470.287 514.251"
